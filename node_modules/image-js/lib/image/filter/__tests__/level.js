...
describe('level', function () {
  describe('extend the image to cover all levels', function () {
    ...
    it('should not change at all an image that has the extreme colors', function () {
      return (0, _common.load)('rgb24bits.png').then(function (image) {
    ...
    it('should change for a normal picture', function () {
      return (0, _common.load)('cat-small.png').then(function (image) {
        let hash = (0, _common.getHash)(image);
        image.level();
        let hash2 = (0, _common.getHash)(image);
  ...
  describe('testing various file format', function () {
    ...
    tests.forEach(function (test) {
      it(`should not change: format/png/${test}`, function () {
        return (0, _common.load)(`format/png/${test}.png`).then(function (image) {
          let hash = (0, _common.getHash)(image);
          image.level();
          let hash2 = (0, _common.getHash)(image);
          expect(hash).toBe(hash2);
